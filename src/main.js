...
import RoomBrowser from "./scenes/RoomBrowser.js";
import RoomLobby from "./scenes/RoomLobby.js";
import NetGameScene from "./scenes/NetGameScene.js";
...
const config = {
  ...
  scene: [InitialScreen, RoomBrowser, RoomLobby, CharacterSelect, NetGameScene, GameScene], // 씬 등록 순서
};
