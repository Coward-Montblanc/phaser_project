...
export default class TempPlayer2 extends Player {
  constructor(scene, tx, ty) {
    super(scene, tx, ty, "tempplayer2");

    // 통합 시트 사용: tempplayer2는 인덱스 39 사용(플레이어3 복제)
    preloadUnifiedSprite(scene);
    ensureSpriteAnimations(scene, "tempplayer2", 39);
    // 초기 텍스처/프레임 설정
